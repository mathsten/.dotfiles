...
let s:p.normal.middle = [ [ s:nord1, s:nord3 ] ]
let s:p.normal.right = [ [ s:nord1, s:nord3 ], [ s:nord1, s:nord3 ] ]
let s:p.normal.warning = [ [ s:nord1, s:nord13 ] ]
let s:p.normal.error = [ [ s:nord1, s:nord11 ] ]

let s:p.inactive.left = [ [ s:nord1, s:nord3 ], [ s:nord1, s:nord1 ] ]
let s:p.inactive.middle = [ [ s:nord1, s:nord1 ] ]
let s:p.inactive.right = [ [ s:nord1, s:nord1 ], [ s:nord1, s:nord1 ] ]

let s:p.insert.left = [ [ s:nord1, s:nord10], [ s:nord5, s:nord3 ] ]
let s:p.replace.left = [ [ s:nord1, s:nord13 ], [ s:nord5, s:nord3 ] ]
let s:p.visual.left = [ [ s:nord1, s:nord7 ], [ s:nord5, s:nord3 ] ]
